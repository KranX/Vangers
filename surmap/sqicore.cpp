...
sqScreen::sqScreen(int _x, int _y, int _sx, int _sy): sqElem(0, 0, 0, 0, 0) {
	x = _x;
	y = _y;
	sx = _sx;
	sy = _sy;
	set(0);
	//	XGR_MouseObj.SetClip(x + XGR_MouseObj.SizeX/2, y + XGR_MouseObj.SizeY/2,x + sx -
	// XGR_MouseObj.SizeX/2, y + sy - XGR_MouseObj.SizeY/2);
}

static unsigned char XMouseMask[64] = {255,
	255,
	255,
	255,
	255,
