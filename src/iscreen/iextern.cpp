...
void iGetMultiGameParameters(void)
{
	...
	switch(iCurMultiGame){
		...
		case iMP_PASSEMBLOSS:
			...
			if(strcmp(game_name,"1+1 mission")==0) value = 500000;
			...
			if(strcmp(game_name,"1+1 mission")==0) value = 1;
			...
			if(strcmp(game_name,"1+1 mission")==0) value = (iGetMultiGameParameter(iMP_PASSEMBLOSS, iMP_CHECKPOINTS_NUM)*1) + 2;
			...
			if(strcmp(game_name,"1+1 mission")==0) value = 2;
