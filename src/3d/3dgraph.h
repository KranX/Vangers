...
enum { DRAW_DEFAULT, DRAW_LINE, DRAW_FLAT, DRAW_GOURAUD };
...
struct Vertex {
	...
	inline void fast_convert() {
		...
		yscr_8 =
			((unsigned char)(MUL_CHAR(A_convert_8.a[3], x_8) + MUL_CHAR(A_convert_8.a[4], y_8) +
