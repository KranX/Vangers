...
void NetworkGetStart(char* name,int& x,int& y)
{
	...
	if (NetworkON && (strcmp(game_name,"satinan")==0 || strcmp(game_name,"�⨭��")==0) && my_server_data.GameType == 2) {
		x = 1650;
		y = 815;
		return;
	}
	else if (NetworkON && (strcmp(game_name,"necrally")==0 || strcmp(game_name,"���ࠫ��")==0) && my_server_data.GameType == 2) {
		x = 1795;
		y = 515;
		return;
	}
	else if (NetworkON && (strcmp(game_name,"aibatr")==0 || strcmp(game_name,"������")==0) && my_server_data.GameType == 0) {
		x = 485;
		y = 1310;
		return;
	}
	...
	else if (NetworkON && (strcmp(game_name,"shutle fostral")==0 || strcmp(game_name,"祫���� ���ࠫ")==0) && my_server_data.GameType == 2) {
		x = 1835;
		y = 1365;
		return;
	}
	...
	else if (NetworkON && (strcmp(game_name,"lens-one")==0 || strcmp(game_name,"����� �����筠�")==0) && my_server_data.GameType == 2) {
		x = 625;
		y = 2275;
		return;
	}
	else if (NetworkON && (strcmp(game_name,"lens-team")==0 || strcmp(game_name,"����� ���������")==0) && my_server_data.GameType == 2) {
		x = 625;
		y = 2275;
		return;
	}
	else if (NetworkON && (strcmp(game_name,"battle for hmok")==0 || strcmp(game_name,"��⢠ �� 嬮�")==0) && my_server_data.GameType == 0) {
		x = 945;
		y = 1760;
		return;
	}
	...
	else if (NetworkON && (strcmp(game_name,"eleerection-sim")==0 || strcmp(game_name,"���४��-ᨬ")==0) && my_server_data.GameType == 2) {
		x = 1960;
		y = 1505;
		return;
	}
	else if (NetworkON && (strcmp(game_name,"mechoxes")==0 || strcmp(game_name,"��宪��")==0) && my_server_data.GameType == 0) {
		x = 1870;
		y = 1055;
		return;
	}
...
if(NetworkON && (strcmp(game_name,"passave")==0 || strcmp(game_name,"���ᥩ�")==0) && my_server_data.GameType == 2) {
