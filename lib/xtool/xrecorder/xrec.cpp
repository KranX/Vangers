...
// Captured events...
static int XREC_CMESSAGES[XREC_MAX_CMESSAGE] = {SDL_KEYDOWN,
	SDL_MOUSEBUTTONDOWN,
	SDL_JOYBUTTONDOWN};

// Ignored events...
static int XREC_IMESSAGES[XREC_MAX_IMESSAGE] = {SDL_MOUSEMOTION, SDL_MOUSEBUTTONUP, SDL_KEYUP};
...
#ifdef _XRECORDER_LOG_
		XRecLog < "\r\nEvent -> " <= nextMsg->Type < "(" <= nextMsg->data[0] < "), frame = " <=
			frameCount;
#endif
	}
}
